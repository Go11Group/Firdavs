...
const (
	Translator_Translate_FullMethodName = "/translate_service.Translator/Translate"
)
...
type TranslatorClient interface {
	Translate(ctx context.Context, in *Uzbek, opts ...grpc.CallOption) (*English, error)
}
...
func (c *translatorClient) Translate(ctx context.Context, in *Uzbek, opts ...grpc.CallOption) (*English, error) {
...
type TranslatorServer interface {
	Translate(context.Context, *Uzbek) (*English, error)
...
func (UnimplementedTranslatorServer) Translate(context.Context, *Uzbek) (*English, error) {
...
func _Translator_Translate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TranslatorServer).Translate(ctx, req.(*Uzbek))
	}
...
var Translator_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "translate_service.Translator",
